          ...
          {!lit ? (
            ...
            >
              <GradientButton onClick={() => {
                try {
                  console.log('CakeScreen: Next clicked');
                  fetch('/api/debug?msg=cake-next-clicked').catch((err) => {
                    console.error('CakeScreen: debug fetch error', err);
                    try { console.error('CakeScreen: fetch error keys', Object.keys(err || {})); } catch(e){}
                  });
                } catch (err) {
                  console.error('CakeScreen: error while handling click', err);
                }
                onNext?.()
              }}>
                Next
